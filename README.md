...
* [`src/clojure_test/styles.cljs`](src/clojure_test/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/clojure_test/`](src/clojure_test/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/clojure_test/core.cljs): contains the SPA entry point, `init`
* [`test/clojure_test/`](test/clojure_test/): test files (ClojureScript,
...
(headless test environment)
    * For Chromium, set the `CHROME_BIN` environment variable in your shell to the command that
    launches Chromium. For example, in Ubuntu, add the following line to your `.bashrc`:
       ...
       ```
5. Clone this repo and open a terminal in the `clojure-test` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/clojure_test/config.cljs) defaults to `true` in
...
(ns clojure-test.example
  (:require [clojure-test.config :as config])
